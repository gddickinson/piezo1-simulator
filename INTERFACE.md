...
|---|---|---|---|
| `cli.py` | Headless command line: `list`, `dome`, `pore`, `hydration`, `modes`, `pockets`, `interactions`, `fusion`, `labelling`, `permeation`, `nanodomain`, `prediction_record`, `variants`, `conservation`, `report`, `batch`. | `main()`, `build_parser()` | ✅ |
